...
export default function AdvancedAnalytics({ dataset, user, onClose }) {
  ...
  const generateChart = async () => {
    ...
    try {
      const res = await axios.post(`${API_BASE_URL}/api/datasets/${dataset.id}/chart`, {
    ...
    <div className="mt-5 border-top border-secondary pt-5">
      <Row className="mb-4">
        <Col className="d-flex justify-content-between align-items-center">
          <h3 className="fw-bold m-0">Analysis: <span className="text-primary">{dataset.dataset_name}</span></h3>
        ...
        <Col md={9}>
          <Card className="glass-card h-100">
            <Card.Body className="d-flex flex-column">
              ...
              <div className="flex-grow-1 d-flex align-items-center justify-content-center" style={{ minHeight: '500px', background: 'rgba(0,0,0,0.2)', borderRadius: '8px' }}>
                {loadingChart ? (
